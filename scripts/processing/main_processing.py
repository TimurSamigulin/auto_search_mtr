"""
    Главный файл для извлечение информации. Запуск данного файла извлючет все доступную информацию из
    собранных нами текстов. В этом файле происходит вызов функций с перечадей входных и выходных файлов
