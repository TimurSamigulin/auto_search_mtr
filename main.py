"""
    Основной файл, отвечающий за вызов функций парсинга текста сайтов из открытых источникв
    Функции:
    get_texts -> list, парсит тексты сайтов
    get_article_urls -> None, Пробегается по всем спаршеным ссылкам, распределяет их по категориям
                        и проверяет магазины это или нет
"""
